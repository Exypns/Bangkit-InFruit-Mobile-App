...
class GradingClassifierHelper(
    var treshold: Float = 0.1f,
    var maxResult: Int = 3,
    val modelName: String = "Grading_with_metadata.tflite",
    val context: Context,
    val classifierListener: GradingClassifierHelper.ClassifierListener?
) {
    ...
    companion object {
        private const val TAG = "Grading Classifier"
    }
